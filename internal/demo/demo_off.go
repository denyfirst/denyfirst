...
// Enabled is false in the ordinary build: this is the tool, and it scans what the
// person running it points it at. That is the whole product.
const Enabled = false

// demoTargets is empty here and never read, because Enabled gates every use of
